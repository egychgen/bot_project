...
class Company:
    ...
    def parsing_divd(self):
        try:
            ...
            pdfkit.from_string(
                '<html><head><meta charset="utf-8"></head><body><h1>Таблица Дивидендов {0}</h></body></html>'.format(
                    self.__tiker), "Otchet_{0}.pdf".format(self.__tiker))



#
#
# Comp1 = Company("RTSI", "RUS")
# Comp2 = Company("SBER", "RUS")
#
# Comp1.Compare_Grafic_Of_To_Companies(Comp2, [0, 100000000000000])
